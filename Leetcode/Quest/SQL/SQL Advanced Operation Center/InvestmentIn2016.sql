...
--     2 - tiv_2015 is the total investment value in 2015 and tiv_2016 is the total investment value in 2016.
--     3 - lat is the latitude of the policy holder's city. It's guaranteed that lat is not NULL.
--     4 - lon is the longitude of the policy holder's city. It's guaranteed that lon is not NULL.
